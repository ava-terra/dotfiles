...
#fish_add_path /home/monkey/.platformio/penv/bin

# opencode
fish_add_path /home/monkey/.opencode/bin
# Commands to run in interactive sessions go here
#
if status is-interactive

    # Set GPG_TTY environment variable to the current terminal for correct
    # pinentry prompts
    set -gx GPG_TTY (tty)
    ...
    # Add Nix profile completions to fish_complete_path
    # set -l nix_profiles $HOME/.nix-profile /nix/var/nix/profiles/default
    # for profile in $nix_profiles
    # if test -d $profile/share/fish/vendor_completions.d
